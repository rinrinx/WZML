...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = getCommand(f'MIRROR_COMMAND', f'm{CMD_PERFIX}'), f'm{CMD_PERFIX}'
        self.UnzipMirrorCommand = getCommand(f'UNZIP_COMMAND', f'uzm{CMD_PERFIX}'), f'uzm{CMD_PERFIX}'
        self.ZipMirrorCommand = getCommand(f'ZIP_COMMAND', f'zm{CMD_PERFIX}'), f'zm{CMD_PERFIX}'
        self.LeechCommand = getCommand(f'LEECH_COMMAND', f'l{CMD_PERFIX}'), f'l{CMD_PERFIX}'
        self.UnzipLeechCommand = getCommand(f'UNZIPLEECH_COMMAND', f'uzl{CMD_PERFIX}'), f'uzl{CMD_PERFIX}'
        self.ZipLeechCommand = getCommand(f'ZIPLEECH_COMMAND', f'zl{CMD_PERFIX}'), f'zl{CMD_PERFIX}'
        self.CloneCommand = getCommand(f'CLONE_COMMAND', f'clone{CMD_PERFIX}'), f'c{CMD_PERFIX}'
        self.QbMirrorCommand = getCommand(f'QBMIRROR_COMMAND', f'qbm{CMD_PERFIX}'), f'qm{CMD_PERFIX}'
        self.QbUnzipMirrorCommand = getCommand(f'QBUNZIP_COMMAND', f'qbum{CMD_PERFIX}'), f'quzm{CMD_PERFIX}'
        self.QbZipMirrorCommand = getCommand(f'QBZIP_COMMAND', f'qbzm{CMD_PERFIX}'), f'qzm{CMD_PERFIX}'
        self.QbLeechCommand = getCommand(f'QBLEECH_COMMAND', f'qbl{CMD_PERFIX}'), f'ql{CMD_PERFIX}'
        self.QbUnzipLeechCommand = getCommand(f'QBZIPLEECH_COMMAND', f'qbul{CMD_PERFIX}'), f'quzl{CMD_PERFIX}'
        self.QbZipLeechCommand = getCommand(f'QBUNZIPLEECH_COMMAND', f'qbzl{CMD_PERFIX}'), f'qzl{CMD_PERFIX}'
        self.ScrapeCommand = getCommand(f'SCRAPE_COMMAND', f'scrape{CMD_PERFIX}'), f'sm{CMD_PERFIX}'
        self.YtdlCommand =  getCommand(f'YTDL_COMMAND', f'y{CMD_PERFIX}'), f'y{CMD_PERFIX}'
        self.YtdlZipCommand = getCommand(f'YTDLZIP_COMMAND', f'yz{CMD_PERFIX}'), f'yz{CMD_PERFIX}'
        self.YtdlLeechCommand = getCommand(f'YTDLLEECH_COMMAND',  f'yl{CMD_PERFIX}'), f'yl{CMD_PERFIX}'
        self.YtdlZipLeechCommand = getCommand(f'YTDLZIPLEECH_COMMAND', f'yzl{CMD_PERFIX}'), f'yzl{CMD_PERFIX}'
