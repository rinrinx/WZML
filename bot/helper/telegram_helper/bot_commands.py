...
class _BotCommands:
    def __init__(self):
        ...
        self.UnzipMirrorCommand = getCommand(f'UNZIP_COMMAND', f'um{CMD_PERFIX}'), f'uzm{CMD_PERFIX}'
        ...
        self.YtdlZipCommand = getCommand(f'YTDLZIP_COMMAND', f'ytzip{CMD_PERFIX}'), f'yz{CMD_PERFIX}'
        self.YtdlLeechCommand = getCommand(f'YTDLLEECH_COMMAND',  f'ytl{CMD_PERFIX}'), f'yl{CMD_PERFIX}'
        self.YtdlZipLeechCommand = getCommand(f'YTDLZIPLEECH_COMMAND', f'ytzl{CMD_PERFIX}'), f'yzl{CMD_PERFIX}'
